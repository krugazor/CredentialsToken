...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/krugazor/CredentialsToken.git", from: "0.1.0"),
    ],
    targets: [
        ...
        .target(
            name: "Sample",
            dependencies: ["Kitura","SwiftMetrics","Health","KituraMarkdown", "KituraStencil", "CredentialsHTTP", "KituraSession","HeliumLogger", "CredentialsToken"]),
    ]
)
